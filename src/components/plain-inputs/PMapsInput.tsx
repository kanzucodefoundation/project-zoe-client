...
export const parseGooglePlace = (dt: GooglePlace): IGPlace => {
    return {
        placeId: dt.place_id,
...
type BaseProps = AutocompleteProps<GooglePlace, OptionalBool, OptionalBool, OptionalBool>
type AutoProps = Omit<BaseProps,
    'variant' | 'multiple' | 'renderInput' | 'onChange' | 'value' | 'options' | 'onInputChange' | 'renderOption'>;
