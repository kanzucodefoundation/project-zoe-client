...
export function SuccessIcon({
  completed, active, error, ...props
}: any) {
  return <CheckCircleIcon {...props} style={{ color: successColor }} />;
}

export function ErrorIcon({
  completed, active, error, ...props
}: any) {
  return <MUIErrorIcon {...props} style={{ color: errorColor }} />;
}

export function WarningIcon({
  completed, active, error, ...props
}: any) {
  return <WatchLaterIcon {...props} style={{ color: warningColor }} />;
}
