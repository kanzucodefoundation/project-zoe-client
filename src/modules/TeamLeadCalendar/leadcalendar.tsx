...
const CellBase = React.memo(
  ({ classes, startDate, formatDate, otherMonth }: IProps) => {
...
const Appointment: any = withStyles(styles, {
  name: "Appointment",
...
const FlexibleSpace: any = withStyles(styles, { name: "ToolbarRoot" })(
  ({ classes, ...restProps }: any) => (
...
export default class LeadCalendar extends React.PureComponent<{}, any> {
